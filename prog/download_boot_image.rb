...
class Prog::DownloadBootImage < Prog::Base
  ...
  BOOT_IMAGE_SHA256 = {
    ...
    ["almalinux-9", "x64", "9.7-20251118"] => "5ff9c048859046f41db4a33b1f1a96675711288078aac66b47d0be023af270d1",
    ["almalinux-9", "arm64", "9.7-20251118"] => "c6c09af3b5be62e0ca82ccfafe0b1de9be90890fa8fddbd6118fa8b76b36de2d",
    ["github-ubuntu-2404", "x64", "20260312.1.0"] => "bbfc41f0db56fb28f5845d37bbe7f4ef1334557b27af68530117bb76ff1b6398",
    ["github-ubuntu-2404", "x64", "20260401.1.0"] => "d0751f04ca3a3052c46aa3afcd23d7b22345adb670ad14b54522502cad6f4e7c",
    ["github-ubuntu-2404", "arm64", "20260312.1.0"] => "c6fb2fa0ae2912be2222a02cf8a25250d4cbaa7b876cd3b24363bb18438deb81",
    ["github-ubuntu-2404", "arm64", "20260401.1.0"] => "2bb2b5d40a7bb8b18f2813073e5e1954ba96c6e389f63cf140db47e2f43b6367",
    ["github-ubuntu-2204", "x64", "20260312.1.0"] => "a50f161933a8ced1018b589f49fa723d2638760366b17fb0112b1e98f1d036c5",
  ...
  label def activate_boot_image
    ...
    Clog.emit("Boot image download completed", [
      image,
      boot_image_download: {
        duration: image.activated_at - image.created_at,
