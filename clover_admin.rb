...
class CloverAdmin < Roda
  ...
  billing_country_options = ISO3166::Country.all.reject { Config.sanctioned_countries.include?(it.alpha2) }.sort_by(&:common_name).map { [it.common_name, it.alpha2] }.freeze
